...
namespace DNLiCore_Utility.Email
{
    #region 邮件帮助辅助类
    /// <summary>
    /// 邮件实体对象
    ...
    public class EmailHelper
    {
        ...
        /// <returns></returns>
        public static bool Send(string sendAddress, string receiverAddress, string subject, string content, string account, string accountPassword, string smtp = "smtp.qq.com", int smtpPort = 25, bool isSsl = false)
        {
